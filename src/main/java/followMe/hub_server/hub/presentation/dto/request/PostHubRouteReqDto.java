...
public record PostHubRouteReqDto(
    @NotNull(message = "출발 허브 ID는 필수입니다.") UUID originHubId,
  ...
  public CreateHubRouteCommand toCommand() {
    return new CreateHubRouteCommand(originHubId, destinationHubId, duration, distance);
  }
}
